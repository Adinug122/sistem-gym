<x-traineer>
 ...
 <div class="mb-6 flex justify-between items-center  gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <h1 class="text-2xl font-bold text-gray-800">
                Dashboard <span class="text-gym-600">Jadwal Latihan</span>
            </h1>

            <a href="{{ route('jadwal.create') }}" class="inline-flex items-center justify-center px-4 py-2 bg-gym-600 text-white rounded-lg hover:bg-gym-500 transition-colors shadow-lg shadow-gym-600/20">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <thead class="bg-gray-50 text-gray-500 border-b border-gray-100">
                    <tr>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider">Hari</th>
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                 ...
                 <a href="{{ route('jadwal.edit',$item->id) }}" class="text-gym-600 hover:text-gym-900 transition-colors" title="Edit Data">
