    ...
    <div class=" w-full max-w-md mx-auto  mt-10">
        <div class="bg-white rounded-lg shadow-lg p-6">
              ...
              <h1 class="text-xl font-bold mb-4 text-gray-800">
                Tambah <span class="text-gym-600">paket</span>
            </h1>
@if ($errors->any())
...
@endif
            ...
            <form action="{{ route('admin.paket.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" class="w-full rounded border px-3 py-2"
                    placeholder="Contoh: Gold Memberhsip 1 bulan">
                </div>

                <div>
                    <label class="block font-medium">Deskripsi</label>
                    <textarea type="text" name="deskripsi" class="w-full rounded border px-3 py-2" placeholder="Contoh: Bebas akses semua alat, free Wifi, handuk gratis.">
                        </textarea>
                </div>

                <div>
                    <label class="block font-medium">Durasi angka</label>
                    <input type="number" name="durasi_angka" min="1" class="no-spinner w-full rounded border px-3 py-2"
