        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                <div class="text-3xl font-black text-white italic mb-6">
                    IRON<span class="text-red-600">GYM</span>
                </div>
                <p class="text-gray-400 leading-relaxed mb-6">
                    Gym premium dengan fasilitas terlengkap dan komunitas yang suportif. Kami siap membantu Anda mencapai versi terbaik dari diri Anda.
                </p>
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-red-600 hover:text-white transition-all">
                    ...
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-green-500 hover:text-white transition-all">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#" class="hover:text-red-500 transition-colors">Membership</a></li>
                    <li><a href="#" class="hover:text-red-500 transition-colors">Jadwal</a></li>
                    <li><a href="#" class="hover:text-red-500 transition-colors">Trainer</a></li>
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm flex gap-2 items-start">
                    ...
                    Jl. Jendral Sudirman No. 88, Jakarta Selatan (Gedung DEFIND Tower Lt. 1)
                </p>
            </div>
